...
const Arrival = sequelize.define(
  "arrivals",
  {
    ...
    total_pallets: { type: DataTypes.INTEGER, validate: { min: 0 } },
    total_boxes: { type: DataTypes.INTEGER, validate: { min: 0 } },
    total_pieces: { type: DataTypes.INTEGER, validate: { min: 0 } },
    total_weight: { type: DataTypes.DECIMAL(10, 2), validate: { min: 0 } },
    actual_received_pallets: { type: DataTypes.INTEGER, defaultValue: 0, validate: { min: 0 } },
    actual_received_boxes: { type: DataTypes.INTEGER, defaultValue: 0, validate: { min: 0 } },
